                        ...
                        <div className="level-right is-hidden-touch" >
                            <div className="columns">
                                <div className="column">
                                    <a href="https://github.com/BlueMoonDevelopment" target="_blank" rel="noreferrer">
                                        <button className="button is-link is-rounded">
                                        <span className="icon">
                                            <i className="fab fa-github"></i>
                                        </span>
                                            <span >BlueMoonDevelopment</span>
                                        </button>
                                    </a></div>
                                <div className="column">
                                    <a href="https://github.com/BlueMoonDevelopment/expenseman-react-client"
